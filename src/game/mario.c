...
s8 sTerrainSounds[7][6] = { 
    ...
    { SOUND_TERRAIN_SNOW,    SOUND_TERRAIN_DEFAULT,SOUND_TERRAIN_SNOW,
      SOUND_TERRAIN_DEFAULT, SOUND_TERRAIN_DEFAULT,SOUND_TERRAIN_STONE }, // TERRAIN_SNOW
    ...
    { SOUND_TERRAIN_DEFAULT, SOUND_TERRAIN_STONE,  SOUND_TERRAIN_GRASS,
      SOUND_TERRAIN_DEFAULT, SOUND_TERRAIN_STONE,  SOUND_TERRAIN_DEFAULT }, // TERRAIN_WATER
...
static u32 set_mario_action_airborne(struct MarioState *m, u32 action, u32 actionArg) {
    ...
    switch (action) {
        ...
        case ACT_TRIPLE_JUMP:
            set_mario_y_vel_based_on_fspeed(m, 69.0f, 0.0f); //this feels all wrong
            m->forwardVel *= 0.8f;
            break;
