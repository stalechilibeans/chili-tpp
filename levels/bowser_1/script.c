...
const LevelScript level_bowser_1_entry[] = {
    INIT_LEVEL(),
    LOAD_RAW(/*seg*/ 0x07, _bowser_1_segment_7SegmentRomStart, _bowser_1_segment_7SegmentRomEnd),
    LOAD_MIO0(/*seg*/ 0x0A, _bidw_skybox_mio0SegmentRomStart, _bidw_skybox_mio0SegmentRomEnd),
    LOAD_RAW(/*seg*/ 0x06, _group12_mio0SegmentRomStart, _group12_mio0SegmentRomEnd),
    ...
    AREA(/*index*/ 1, bowser_1_geo_0000D0),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ 0, 3600, 0, /*angle*/ 0, 180, 0, /*behParam*/ 0x000A0000, /*beh*/ bhvWarps6C),
