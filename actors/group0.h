...
extern GeoLayout RCP_TitleMario[];
...
extern Gfx RCP_luigi_head7[];
extern Gfx RCP_luigi_head8[];
extern Gfx RCP_luigi_far_head1[];
extern Gfx RCP_luigi_far_head2[];
extern Gfx RCP_luigi_far_head3[];
extern Gfx RCP_luigi_far_head4[];
extern Gfx RCP_luigi_far_head5[];
extern Gfx RCP_luigi_far_head6[];
extern Gfx RCP_luigi_far_head7[];
extern Gfx RCP_luigi_far_head8[];
extern Gfx RCP_luigi_swim_hand_l[];
extern Gfx RCP_luigi_swim_hand_r[];
extern Gfx RCP_luigi_vsign_hand[];
extern Gfx RCP_luigi_near_body[];
extern Gfx RCP_luigi_mid_body[];
extern Gfx RCP_luigi_far_body[];
